...
<div class="task-trekBreadcrumbs-container {size}">
  ...
  {#if afterLabel || $$slots.afterLabel}
    <span class="task-trekBreadcrumbs-afterLabel font-medium-12">
...
<style lang="scss">
  .task-trekBreadcrumbs-container {
    display: flex;
    align-items: center;
    height: var(--global-small-Size);
    min-width: 0;

    .task-trekBreadcrumbs-afterLabel {
      white-space: nowrap;
