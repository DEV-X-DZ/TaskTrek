...
<div class="task-trekPanels-container">
  {#if visibleNav}
    <div
    ...
    >
      <div class="antiPanel-wrap__content task-trekNavPanel-container">
        <div class="task-trekNavPanel-header">
  ...
  {#if asideComponent != null}
    ...
    <div class="task-trekSidePanel-container">
      {#key asideProps}
