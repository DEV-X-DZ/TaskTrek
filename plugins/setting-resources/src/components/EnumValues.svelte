...
<div class="task-trekTableAttr-container mt-6">
  ...
  {#if value.enumValues.length > 0 || newItem}
    <div class="task-trekTableAttr-content options">
      <EnumValuesList
      ...
      />
      {#if newItem}
        <div class="task-trekTableAttr-content__row hovered">
          <div class="task-trekTableAttr-content__row-dragMenu">
            <IconMoreV2 size={'small'} />
          </div>
          <div class="task-trekTableAttr-content__row-label font-regular-14 accent grow">
            <ModernEditbox
              kind={'ghost'}
              size={'small'}
          ...
          {#if matched}
            <div class="task-trekChip-item error font-medium-12">
