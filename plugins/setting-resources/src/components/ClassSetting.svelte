...
<div class="task-trekComponent">
  ...
  <div class="task-trekComponent-content__container columns">
    <div class="task-trekComponent-content__column">
      <div class="task-trekComponent-content__navHeader divide">
        ...
        <div class="task-trekComponent-content__navHeader-hint paragraph-regular-14">
    ...
    <div class="task-trekComponent-content__column content">
      <Scroller align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
        <div class="task-trekComponent-content">
          {#if _class !== undefined}
