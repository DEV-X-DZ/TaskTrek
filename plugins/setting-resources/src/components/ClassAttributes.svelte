...
<div class="task-trekTableAttr-container">
  <div class="task-trekTableAttr-header font-medium-12" class:withButton={showHierarchy}>
    {#if showHierarchy}
  ...
  {#if showHierarchy}
    <div class="task-trekTableAttr-content class withTitle">
      <div class="task-trekTableAttr-content__title">
        <Label label={settings.string.Properties} />
      </div>
      <div class="task-trekTableAttr-content__wrapper">
        <ClassAttributesList
          {_class}
          {ofClass}
          {attributeMapper}
  ...
  {:else if hasCustomAttributes(_class)}
    <div class="task-trekTableAttr-content class">
      <ClassAttributesList
        {_class}
        {ofClass}
        {attributeMapper}
