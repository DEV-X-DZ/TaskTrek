...
{#each values as item, i}
  ...
  >
    <button class="task-trekTableAttr-content__row-dragMenu" class:drag={!disableMouseOver}>
      <IconMoreV2 size={'small'} />
    </button>
    <div class="task-trekTableAttr-content__row-label font-regular-14 accent">
      {item}
    </div>
    <div class="task-trekTableAttr-content__row-label grow" />
    {#if !disableMouseOver}
      <ButtonIcon
        kind={'tertiary'}
        icon={IconMoreV}
