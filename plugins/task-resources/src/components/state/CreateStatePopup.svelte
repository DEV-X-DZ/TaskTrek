...
>
  ...
  <div class="task-trekModal-content__titleGroup">
  ...
  <div class="task-trekModal-content__settingsSet">
    <div class="task-trekModal-content__settingsSet-line">
  ...
  <div class="task-trekModal-content__settingsSet table">
    <div class="task-trekTableAttr-container">
      <div class="task-trekTableAttr-header font-medium-12 withButton">
        <ButtonMenu
          {items}
          {selected}
          icon={IconSettings}
      ...
      <div class="task-trekTableAttr-content" class:mb-2={selected === 1}>
        {#if selected === 0}
          <ColorsPopup
