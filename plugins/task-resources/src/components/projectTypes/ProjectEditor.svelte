...
{#if type !== undefined && descriptor !== undefined}
  <Header minimize={!visibleNav} on:resize={(event) => dispatch('change', event.detail)}>
    ...
    <!-- <svelte:fragment slot="actions">
      <div class="task-trekHeader-buttonsGroup__label font-regular-12">
  ...
  <div class="task-trekComponent-content__container columns">
    {#if selectedTaskTypeId === undefined}
      <div class="task-trekComponent-content__column">
        <div class="task-trekComponent-content__navHeader">
          <div class="task-trekComponent-content__navHeader-menu">
    ...
    {/if}
    <div class="task-trekComponent-content__column content">
      <Scroller bind:this={scroller} align={'center'} padding={'var(--spacing-3)'} bottomPadding={'var(--spacing-3)'}>
        <div class="task-trekComponent-content gap">
          {#if selectedTaskType === undefined}
            <div class="task-trekComponent-content__column-group">
              <div class="task-trekComponent-content__header">
            ...
            <div bind:this={navigator[1].element} class="task-trekTableAttr-container">
              <div class="task-trekTableAttr-header font-medium-12">
              ...
              {#if taskTypes.length}
                <div class="task-trekTableAttr-content task">
                  {#each taskTypes as taskType}
                    <button
                      class="task-trekTableAttr-content__row"
                      on:click|stopPropagation={() => {
                        selectTaskType(taskType._id)
                      }}
                    >
                      <div class="task-trekTableAttr-content__row-icon-wrapper">
                        <TaskTypeIcon value={taskType} size={'small'} />
                      </div>
                      {#if taskType.name}
                        <div class="task-trekTableAttr-content__row-label font-medium-14">
                          {taskType.name}
                        </div>
                      {/if}
                      <div class="task-trekTableAttr-content__row-label grow dark font-regular-14">
            ...
            <div bind:this={navigator[3].element} class="task-trekTableAttr-container">
              <div class="task-trekTableAttr-header font-medium-12">
